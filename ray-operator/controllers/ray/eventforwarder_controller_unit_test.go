...
func (c *capturingRecorder) Event(object runtime.Object, eventtype, reason, message string) {
	c.events = append(c.events, capturedEvent{object: object, eventtype: eventtype, reason: reason, message: message})
}
...
func (c *capturingRecorder) AnnotatedEventf(object runtime.Object, annotations map[string]string, eventtype, reason, messageFmt string, args ...any) {
...
func TestEventForwarder_AnnotationsCarrySourceEvent(t *testing.T) {
	recorder := &capturingRecorder{}
	r := newEventForwarder(t, recorder, EventForwarderOptions{},
		&rayv1.RayCluster{ObjectMeta: metav1.ObjectMeta{Name: "cluster-a", Namespace: "default"}},
		rayPodOnNode("a-head", "default", "cluster-a", "node-1"),
	...
	assert.Equal(t, map[string]string{
		"ray.io/source-node":       "node-1",
		"ray.io/source-event-uid":  "evt-1-uid",
		"ray.io/source-event-name": "evt-1",
	}, recorder.events[0].annotations)
}
